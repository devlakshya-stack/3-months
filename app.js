(() => {
  ...
  function heartIntro() {
    ...
    function draw(now) {
      ...
      for (const point of points) {
        ...
        const x =
          width / 2 +
          (point.x - width / 2) * progress +
          driftX;

        const y =
          height / 2 +
          (point.y - height / 2) * progress +
          driftY;
  ...
  /* =====================================================
     GALLERY
     FIXED IMAGE LOADING
     Photos can be beside index.html.
     ===================================================== */
  ...
  function music() {
    ...
    /*
      content.js should contain:

      song: 'our-song.mp3'

      The MP3 should be beside index.html:
    ...
    toggle.addEventListener(
      ...
      async () => {
        ...
        try {
          ...
          alert(
            `The song could not be played.\n\nMake sure "${songPath}" is in the same folder as index.html.`
          );
        }
      }
    );
